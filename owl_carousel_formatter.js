...
Drupal.behaviors.owl_carousel = {
  attach: function (context) {
    ...
    (jQuery)(window).bind('load', function() {
      (jQuery)('.owl_carousel:not(.gallery-processed)', context).each(function(){
        Drupal.owl_carousel.prepare(this);
      }).addClass('gallery-processed');
    });
  }
};

Drupal.owl_carousel = Drupal.owl_carousel || {};

// setting up the main behaviour
Drupal.owl_carousel.prepare = function(el) {
  (function ($) {
    // var $settings = Drupal.settings.owl_carousel;
    $el = $(el);
